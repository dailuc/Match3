...
public class ObjectHandleGamePlay : GamePlayManagerCtrlAbstract
{
    ...
    {
        Transform hightLightStart = this.ObjectStart.Find(HightLightSpawner.ClickHightLight);
        HightLightSpawner.Instance.Despawn(hightLightStart);
        Transform hightLightEnd = this.ObjectEnd.Find(HightLightSpawner.ClickHightLight);
    ...
    public virtual void SetObject(Transform Object)
    {
        ...
        if (this.ObjectStart == null)
        {
            ...
            Transform newObj = HightLightSpawner.Instance.Spawn(HightLightSpawner.ClickHightLight,
                                                Object.position, Quaternion.identity);
            newObj.gameObject.SetActive(true);
            newObj.SetParent(Object.transform);
            return;
        }
